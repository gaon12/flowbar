...
const features_js_1 = require("./runtime/features.js");
...
exports.stream = features_js_1.streamWithProgress;
exports.group = features_js_1.createGroup;
exports.task = features_js_1.task;
function configure(defaultOptions = {}) {
    return Object.freeze({
        ...
        stream: (options = {}) => (0, features_js_1.streamWithProgress)({ ...defaultOptions, ...options }),
        group: (options = {}) => (0, features_js_1.createGroup)({ ...defaultOptions, ...options }),
        task: (label, handler, options = {}) => (0, features_js_1.task)(label, handler, { ...defaultOptions, ...options }),
